function varargout = dialog_mathoper(varargin)
% DIALOG_MATHOPER MATLAB code for dialog_mathoper.fig
%      DIALOG_MATHOPER, by itself, creates a new DIALOG_MATHOPER or raises the existing
%      singleton*.
%
%      H = DIALOG_MATHOPER returns the handle to a new DIALOG_MATHOPER or the handle to
%      the existing singleton*.
%
%      DIALOG_MATHOPER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DIALOG_MATHOPER.M with the given input arguments.
%
%      DIALOG_MATHOPER('Property','Value',...) creates a new DIALOG_MATHOPER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dialog_mathoper_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dialog_mathoper_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dialog_mathoper

% Last Modified by GUIDE v2.5 27-Nov-2017 13:05:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dialog_mathoper_OpeningFcn, ...
                   'gui_OutputFcn',  @dialog_mathoper_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dialog_mathoper is made visible.
function dialog_mathoper_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dialog_mathoper (see VARARGIN)
...
% Choose default command line output for dialog_mathoper
%handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dialog_mathoper wait for user response (see UIRESUME)
uiwait(handles.figure_dialog_mathoper);


% --- Outputs from this function are returned to the command line.
function varargout = dialog_mathoper_OutputFcn(hObject, eventdata, handles) 
